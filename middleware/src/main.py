...
app.config['NODE_SERVER_URL'] = os.environ.get('NODE_SERVER_URL', 'https://besu.example.com/api')
...
app.config['AGENT_URL'] = 'http://10.0.0.1:28080'
...
app.config['AGENT_GTP_ADDR'] = os.environ.get('AGENT_GTP_ADDR', '10.0.0.1')
app.config['AGENT_TDD_CONFIG'] = int(os.environ.get('AGENT_TDD_CONFIG', '1'))
app.config['AGENT_AMF_ADDR'] = os.environ.get('AGENT_AMF_ADDR', '10.0.0.2')
